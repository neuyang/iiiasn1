...
void testBERCoder()
{
	...
	TEST("value GetRequest ::= { header-only TRUE,\n\taccept-types { standards {html, plain-text}),\n\turl \"www.asn1.com\" }",
		env, gr1, gr2, "\x30\x17\x80\x01\xFF\xA2\x04\x80\x02\x06\xc0\x83\x0c"
